...
export function businessSchema() {
  ...
  return {
    ...
    'description': 'O.M.T (Oliveira Maçonnerie Tours), artisan maçon à Tours : maçonnerie générale, terrassement et ravalement de façade en Indre-et-Loire, région Centre-Val de Loire et Pays de la Loire.',
    'url': absoluteUrl('/'),
