...
export function usePageSeo({ title, description, path, image = '/images/og-omt-maconnerie-tours.jpg', schema = [] }: PageSeo) {
  ...
  useSeoMeta({
    ...
    ogType: 'website',
    ogLocale: 'fr_FR',
    ogSiteName: `${site.shortName} – ${site.fullName}`,
    ogImage: img,
    ogImageWidth: 1200,
    ogImageHeight: 630,
    ogImageAlt: `${site.shortName} – ${site.fullName}, maçon à Tours`,
...
export function businessSchema() {
  ...
  return {
    ...
    'legalName': site.shortName,
    'alternateName': [site.fullName, 'O.M.T', 'OMT', 'O.M.T Maçonnerie', 'O.M.T Maçonnerie Tours', 'OMT Maçonnerie Tours', 'Oliveira Maçonnerie'],
    'description': 'O.M.T (Oliveira Maçonnerie Tours), artisan maçon à Tours : maçonnerie générale, terrassement, ravalement de façade et carrelage en Indre-et-Loire, région Centre-Val de Loire et Pays de la Loire.',
    'url': absoluteUrl('/'),
    'logo': absoluteUrl('/images/logo-omt-carre.png'),
    'slogan': site.slogan,
